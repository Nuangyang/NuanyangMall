...
$(function () {
    ...
    var goodsid=sessionStorage.getItem("goodsid")
        //所有商品
    var showgids=sessionStorage.getItem("showsid")
    //转回对象
    var goods=JSON.parse(goodsid)
    var showgid=JSON.parse(showgids)
    if(null!=goodsid){
        //动态构建商品详情
        str="<div class=\"backgr\">\n" +
            "\t\t\t\t<div class=\"detail_wrap\">\n" +
            "\t\t\t\t\t\n" +
            "\t\t\t\t\t<!--商品图片-->\n" +
            "\t\t\t\t\t<div class=\"good_simg\">\n" +
            "\t\t\t\t\t\t<img src=\""+goods.data.img+"\" class=\"goods_img_show\"/>\n" +
            "\t\t\t\t\t</div>\n" +
            "\t\t\n" +
            "\t\t\t\t\t\n" +
            "\t\t\t\t\t<!--商品详情-->\n" +
            ...
            "\t\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t<h2 class=\"gname\">"+goods.data.gname+"</h2>\n" +
            "\t\t\t\t\t<!--购买人数-->\n" +
            "\t\t\t\t\t\t<div class=\"r_second\">\n" +
            "\t\t\t\t\t\t\t<ul class=\"price_module\">\n" +
            "\t\t\t\t\t\t\t\t<li class=\"jumei_price\">\n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"jp_cur\">￥</em>\n" +
            "\t\t\t\t\t\t\t\t\t<span>"+goods.data.gprive+"</span>\n" +
            "\t\t\t\t\t\t\t\t</li>\n" +
            "\t\t\t\t\t\t\t</ul>\n" +
            "\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t<!--促销-->\n" +
            "\t\t\t\t\t\t\t<div class=\"r_second_policy_wrap\">\n" +
            "\t\t\t\t\t\t\t\t<p class=\"r_second_policy\"> \n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"zhe\">折</em>\n" +
            "\t\t\t\t\t\t\t\t\t<span class=\"man\">满2件打9折,3件85折</span>\n" +
            "\t\t\t\t\t\t\t\t</p>\n" +
            "\t\t\t\t\t\t\t</div>\n" +
            "\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t<!--购买人数-->\n" +
            "\t\t\t\t\t\t\t<div class=\"people_clearfix\">\n" +
            "\t\t\t\t\t\t\t\t<div class=\"num_fl\">\n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"rushu\">45687</em>\n" +
            "\t\t\t\t\t\t\t\t\t人已购买\n" +
            "\t\t\t\t\t\t\t\t</div>\n" +
            "\t\t\t\t\t\t\t</div>\n" +
            "\t\t\t\t\t\t\t\n" +
            ...
            "\t\t\t\t\t\t\t<div class=\"r_second>\n" +
            "\t\t\t\t\t\t\t\t<dl class=\"mail_op\">\n" +
            "\t\t\t\t\t\t\t\t\t<dt class=\"dts\">包邮政策：</dt>\n" +
            "\t\t\t\t\t\t\t\t\t<dd class=\"dds\">本商品单件包邮（高原部分地区除外）</dd>\n" +
            "\t\t\t\t\t\t\t\t</dl>\n" +
            "\t\t\t\t\t\t\t\t<dl class=\"mail_op\">\n" +
            "\t\t\t\t\t\t\t\t\t<dt class=\"dts\">商品简介：</dt>\n" +
            "\t\t\t\t\t\t\t\t\t<dd class=\"dds\">"+goods.data.gdescribe+"</dd>\n" +
            "\t\t\t\t\t\t\t\t</dl>\n" +
            "\t\t\t\t\t\t\t\t<dl class=\"mail_op\">\n" +
            "\t\t\t\t\t\t\t\t\t<dt class=\"dts1\">商品库存：</dt>\n" +
            "\t\t\t\t\t\t\t\t\t<dd class=\"dds1\">仅剩：\n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"goods_num\">"+goods.data.gnum+"</em>\n" +
            "\t\t\t\t\t\t\t\t\t<em>件</em>\n" +
            "\t\t\t\t\t\t\t\t\t</dd>\n" +
            "\t\t\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t\t</dl>\n" +
            "\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t\t<dl class=\"mail_num\"></dl>\n" +
            "\t\t\t\t\t\t\t</div>\n" +
            "\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t<!--加入购物车-->\n" +
            "\t\t\t\t\t\t\t<div class=\"r_fourth\">\n" +
            "\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"addgoods\" zhuyegid='"+goods.data.gid+"' onclick='addShopping(this)'>\n" +
            "\t\t\t\t\t\t\t\t\t<span class=\"add\" zhuyegid='"+goods.data.gid+"'>加入购物车</span>\n" +
            "\t\t\t\t\t\t\t\t\t<i></i>\n" +
            "\t\t\t\t\t\t\t\t</a>\n" +
            "\t\t\t\t\t\t\t</div>\n" +
            "\t\t\t\t\t\t</div>\n" +
        ...
        $(".global_body").append(str)
        sessionStorage.removeItem("goodsid");

    }else if(null!=showgid){
        //动态构建商品详情
        str="<div class=\"backgr\">\n" +
            "\t\t\t\t<div class=\"detail_wrap\">\n" +
            "\t\t\t\t\t\n" +
            "\t\t\t\t\t<!--商品图片-->\n" +
            "\t\t\t\t\t<div class=\"good_simg\">\n" +
            "\t\t\t\t\t\t<img src=\""+showgid.data.img+"\" class=\"goods_img_show\"/>\n" +
            "\t\t\t\t\t</div>\n" +
            "\t\t\n" +
            "\t\t\t\t\t\n" +
            "\t\t\t\t\t<!--商品详情-->\n" +
            "\t\t\t\t\t<div class=\"good_details\">\n" +
            "\t\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t<h2 class=\"gname\">"+showgid.data.gname+"</h2>\n" +
            "\t\t\t\t\t<!--购买人数-->\n" +
            "\t\t\t\t\t\t<div class=\"r_second\">\n" +
            "\t\t\t\t\t\t\t<ul class=\"price_module\">\n" +
            "\t\t\t\t\t\t\t\t<li class=\"jumei_price\">\n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"jp_cur\">￥</em>\n" +
            "\t\t\t\t\t\t\t\t\t<span>"+showgid.data.gprive+"</span>\n" +
            "\t\t\t\t\t\t\t\t</li>\n" +
            "\t\t\t\t\t\t\t</ul>\n" +
            "\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t<!--促销-->\n" +
            ...
            "\t\t\t\t\t\t\t\t<dl class=\"mail_op\">\n" +
            "\t\t\t\t\t\t\t\t\t<dt class=\"dts\">商品简介：</dt>\n" +
            "\t\t\t\t\t\t\t\t\t<dd class=\"dds\">"+showgid.data.gdescribe+"</dd>\n" +
            "\t\t\t\t\t\t\t\t</dl>\n" +
            "\t\t\t\t\t\t\t\t<dl class=\"mail_op\">\n" +
            "\t\t\t\t\t\t\t\t\t<dt class=\"dts1\">商品库存：</dt>\n" +
            "\t\t\t\t\t\t\t\t\t<dd class=\"dds1\">仅剩：\n" +
            "\t\t\t\t\t\t\t\t\t<em class=\"goods_num\">"+showgid.data.gnum+"</em>\n" +
            "\t\t\t\t\t\t\t\t\t<em>件</em>\n" +
            "\t\t\t\t\t\t\t\t\t</dd>\n" +
            "\t\t\t\t\t\t\t\t\t\n" +
            "\t\t\t\t\t\t\t\t</dl>\n" +
            ...
            "\t\t\t\t\t\t\t<!--加入购物车-->\n" +
            "\t\t\t\t\t\t\t<div class=\"r_fourth\">\n" +
            "\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"addgoods\" showgid='"+showgid.data.gid+"' onclick='addShopping(this)'>\n" +
        ...
        $(".global_body").append(str)
        sessionStorage.removeItem("showgid");
...
//添加购物车
function addShopping(dom) {

    var gdom=$(dom)

    //获取商品ID
    //所有商品信息
    var gid=gdom.attr("showgid")
    console.log(gid)
    if(gid!=undefined){
        //传入后端添加购物车
        $.post("/goods.do?method=addShopping",{gid:gid},function (dom) {
            if(dom.code==200){
                alert("添加成功！")
            }else{
                alert("添加失败！QAQ你想要的被别人抢光了")
            }
        },"json")
    }else{
        //主页商品信息
        var gidz=gdom.attr("zhuyegid")
        console.log(gidz)
        //传入后端添加购物车
        $.post("/goods.do?method=addShoppingAll",{gid:gidz},function (dom) {
            if(dom.code==200){
                alert("添加成功！")
            }else{
                alert("添加失败！QAQ你想要的被别人抢光了")
