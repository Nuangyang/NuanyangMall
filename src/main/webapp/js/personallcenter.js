...
$(function () {
    ...
    //获取用户信息展示
    $.post("/user.do?method=getUserPersonalCenter",function (dom) {
        ...
        if(dom.code==200){
            ...
            if(dom.data.state==1){
                ...
                var str="   <img src=\""+dom.data.head+"\" alt=\"\"  class=\"img-user\"/>\n" +
                    "                        <div class=\"user-uanme\">"+dom.data.uname+"</div>\n" +
                    "                        <div class=\"user-emil\">"+dom.data.uemail+"</div>"

                $(".user-touxiang").append(str)



                var sbu="<div class=\"formfield-root\">\n" +
                    "                                                   <div class=\"formfield-control\">头像</div>\n" +
                    "\n" +
                    "                                                   <div class=\"formfield-img\">\n" +
                    "                                                       <div class=\"avatar-box\">\n" +
                    "                                                           <img src=\""+dom.data.head+"\" alt=\"\" / class=\"avatar-image\">\n" +
                    "                                                       </div>\n" +
                    "                                                   </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "                                                   <div class=\"formfield-uname\">昵称:</div>\n" +
                    "\n" +
                    "                                                   <div class=\"formfield-useruname\">\n" +
                    "                                                       <div class=\"uname\">"+dom.data.uname+"</div>\n" +
                    "                                                   </div>\n" +
                    "                                               </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "\n" +
                    "                                               <div class=\"formfield-users\">\n" +
                    "                                                   <div class=\"formfield-uname\">手机号:</div>\n" +
                    "\n" +
                    "                                                   <div class=\"formfield-useruname\">\n" +
                    "                                                       <div class=\"uname\">"+dom.data.uphone+"</div>\n" +
                    "                                                   </div>\n" +
                    "                                               </div>\n" +
                    "\n" +
                    "\n" +
                    "                                               <div class=\"formfield-users\">\n" +
                    "                                                   <div class=\"formfield-uname\">账户状态:</div>\n" +
                    "\n" +
                    "                                                   <div class=\"formfield-useruname\">\n" +
                    "                                                       <div class=\"uname\" style=\"color:#c0e332;\"><a href=\"javascript:void(0)\">正式大会员</a></div>\n" +
                    "                                                   </div>\n" +
                    "                                               </div>\n" +
                    "\n" +
                    "\n" +
                    "                                               <div class=\"formfield-users\">\n" +
                    "                                                   <div class=\"formfield-uname\">出生年月:</div>\n" +
                    "\n" +
                    "                                                   <div class=\"formfield-useruname\">\n" +
                    "                                                       <div class=\"uname\">"+dom.data.birthday+"</div>\n" +
                    "                                                   </div>\n" +
                    "                                               </div>\n" +
                    "                                           </div>"
                ...
                //默认头像
                var str="   <img src=../../images/defuimg.png alt=\"\"  class=\"img-user\"/>\n" +
                    "                        <div class=\"user-uanme\">"+dom.data.uname+"</div>\n" +
                    "                        <div class=\"user-emil\">"+dom.data.uemail+"</div>"
                ...
                var sbu="<div class=\"formfield-root\">\n" +
                    ...
                    "                                                   <div class=\"formfield-img\">\n" +
                    "                                                       <div class=\"avatar-box\">\n" +
                    "                                                           <img src=\"../../images/defuimg.png\" alt=\"\" / class=\"avatar-image\">\n" +
                    "                                                       </div>\n" +
                    "                                                   </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "\n" +
                    "                                                   <div class=\"formfield-useruname\">\n" +
                    "                                                       <div class=\"uname\" style=\"color: rgb(255, 92, 0);\"><a href=\"Activate.html\">注册会员</a></div>\n" +
                    "                                                   </div>\n" +
                    "                                               </div>\n" +
                    "\n" +
                    "\n" +
...
//退出
function delUser() {
    $.post("/user.do?method=delSession",function () {
        //跳转当前页面
        location.href="/html/frontpage/homepage.html"
    },"json")
...
function dianjiDel() {
    ...
    $(".tor-span").text("修改信息")
        //修改右边显示修改功能页面
    var string="\n" +
        "                            <div class=\"formfield-roots\">\n" +
        "                                <form action=\"/user.do?method=addUserTouXiang\" method=\"post\" enctype=\"multipart/form-data\">\n" +
        "                                <p style=\"font-size: 17px;\">上传新头像</p>\n" +
        "                                <input type=\"file\" class=\"formfield-controlc\" name=\"upload\" />\n" +
        "                                <input type=\"submit\" value=\"上传头像\"  class=\"tijiaotouxiang\"/>\n" +
        "                                </form>\n" +
        "                            </div>\n" +
        "\n" +
        "\n" +
        ...
        "\n" +
        "                                <div class=\"formfield-useruname\">\n" +
        "                                    <div class=\"uname\"><p>==========修改个人信息==========</p></div>\n" +
        "                                </div>\n" +
        "                            </div>\n" +
        "\n" +
        "\n" +
        "                        <form action=\"#\" method=\"post\" onsubmit='updaUser()'>\n" +
        "\n" +
        "                            <div class=\"formfield-users\">\n" +
        "                                <div class=\"formfield-uname\">修改密码</div>\n" +
        "\n" +
        "                                <div class=\"formfield-useruname\">\n" +
        "                                    <input type=\"password\" name=\"upwd\" id='mima' placeholder=\"这里输入密码\" class=\"inputs\"/>\n" +
        "                                </div>\n" +
        "                            </div>\n" +
        "\n" +
        "\n" +
        "                            <div class=\"formfield-users\">\n" +
        "                                <div class=\"formfield-uname\">修改手机</div>\n" +
        "\n" +
        "                                <div class=\"formfield-useruname\">\n" +
        "                                    <input type=\"text\" name=\"ushouji\" id='shouji' placeholder=\"这里输入手机\" class=\"inputs\"/>\n" +
        "                                </div>\n" +
        "                            </div>\n" +
        "\n" +
        "\n" +
        "                            <div class=\"formfield-users\">\n" +
        "                                <div class=\"formfield-uname\">性别</div>\n" +
        "\n" +
        "                                <div class=\"formfield-useruname\">\n" +
        "                                    <div class=\"sex-input\">\n" +
        ...
        "\n" +
        "                                <div class=\"formfield-useruname\">\n" +
        "                                    <input type=\"text\" name=\"birthday\"  id='shengri' placeholder=\"这里输入生日\" class=\"inputs\"/>\n" +
        "                                </div>\n" +
        "                            </div>\n" +
        "\n" +
        "\n" +
        "                                    <input type=\"submit\" value=\"提交修改\" class=\"dianji\"/>\n" +
        "                        </form>\n" +
        "                        </div>\n"
...
function shouwuo() {
    ...
    //获取当前用户默认地址信息
    $.post("/user.do?method=getUsermrenAddress",function (ust) {

        console.log(ust)
        if(ust.code==200){
            var strsdsd="<div class=\"formfield-root\">\n" +
                " <div class=\"formfield-control\">默认地址：</div>\n" +
                "                                <div class=\"formfield-img\">\n" +
                "                       <i>收件人:</i> <span>"+ust.data.aname+"</span>\n" +
                "                       <i>手机号:</i> <span>"+ust.data.aphoe+"</span>\n" +
                "                                        <p class=\"moren\">"+ust.data.address+"</p>\n" +
                "                                </div>\n" +
                "                    <div class=\"dizhi\">\n" +
                "                        <p>已有地址:</p>\n" +
                "                        <ul class=\"gengduodizhi\">\n" +
                "                        </ul>\n" +
                "                    </div>\n";
            ...
            //默认加载
            var suu=     "                    <div class=\"xinzen\">\n" +
                "                    <p>新增地址</p>\n" +
                "                        <form action=\"#\" method=\"post\" onsubmit='adddizhi()'>\n" +
                "                            <input type=\"text\" placeholder=\"收件人\" id='sname'/>\n" +
                "                            <input type=\"text\" placeholder=\"收件人手机号\" id='sphon'/>\n" +
                "                            <select name=\"\" id=\"as1\" onchange=\"addcity(this)\" >\n" +
                "                            <option value=\"-1\">====请选择===</option>\n" +
                "\n" +
                "                             </select>\n" +
                "                            <select id=\"arr\">\n" +
                "                            <option value=\"\" id=\"asd\"  >====请选择===</option>\n" +
                "\n" +
                "                             </select>\n" +
                "                            <input type=\"text\" placeholder=\"详细地址\" id='xianqing'/>\n" +
                "                            <input type=\"submit\" value=\"一键新增\" />\n" +
                "                        </form>\n" +
                "                        </div>\n" +
                "                    </div>\n";
            $("#xixi").append(suu);
            ...
            //预加载省
            $.post("/user.do?method=addsheng",function (data) {
            ...
            var strsdsd="<div class=\"formfield-root\">\n" +
                " <div class=\"formfield-control\">默认地址：</div>\n" +
                "                                <div class=\"formfield-img\">\n" +
                "                       <i>收件人:</i> <span>暂无</span>\n" +
                "                       <i>手机号:</i> <span>暂无</span>\n" +
                "                                        <p class=\"moren\">暂无</p>\n" +
                "                                </div>\n" +
                "                    <div class=\"dizhi\">\n" +
                "                        <p>已有地址:</p>\n" +
...
/*    var selectR = $('input:radio:checked');*/
    ...
    if(null!=upwd||null!=shouji||null!=selectR||null!=shengri){
        ...
        if(upwd.length>5){
            ...
            if(/^1[3|4|5|8][0-9]\d{4,8}$/.test(shouji)) {
                ...
                //发送数据到后端
                $.post("/user.do?method=updaUserXinXi",{upwd:upwd,shouji:shouji,selectR:1,shengri:shengri},function(dosm) {
...
function addcity(dom) {
    ...
    $.post("/user.do?method=addshi",{City:addcity.val()},function(data){
        del();
        var city=$(data.data);
        $.each(city,function () {
            var  city=$(this);
            var str="<option value="+city[0].id+" >"+city[0].name+"</option>"
            $("#arr").append(str);
        })
    },"json")
}
...
function adddizhi() {
 ...
 var  sheng=$("#as1").val();
  ...
  var  shi=$("#arr").val()
    //拿到用户输入的详细地址
    var xiangqing=$("#xianqing").val()

    if(null!=xiangqing&&null!=sname&&null!=sphon){
        $.post("/user.do?method=addDiZhi",{sheng:sheng,shi:shi,xianqin:xiangqing,sname:sname,sphon:sphon},function (domst) {
...
//删除地址信息
function delUserRess(pdd) {

    var aid=$(pdd)
    //获取当前地址ID
    var useraid=aid.attr("aid")

    $.post("/user.do?method=delUserDizhi",{aid:useraid},function (dds) {

        if(dds.code==200){
            //删除当前li
            pdd.parentElement.remove();
        }else{
            alert("服务君出现问题了 你得联系管理员哦")
        }
...
function xiugai(udd) {
    ...
    //获取要修改成默认地址得地址ID
    var aid=$(udd).attr("aid")

    $.post("/user.do?method=upDateUserRess",{aid:aid},function (dom) {
        if(dom.code==200){
            //刷新当前界面
            location.reload();
...
//预加载用户地址信息
function  addUserRessAll() {


    //获取用户所有地址信息
    $.post("/user.do?method=getUserAddress",function (dos) {


        for(var i=0;i<dos.data.length;i++){
            console.log(1)
            var stt="<li><i>收件人：</i><span>"+dos.data[i].aname+"</span><br/><span>"+dos.data[i].address+"</span>&nbsp<i>手机号：</i><span>"+dos.data[i].aphoe+"</span>&nbsp;" +
                "<button aid='"+dos.data[i].aid+"' onclick='xiugai(this)'>更换默认</button>&nbsp;&nbsp;<button aid='"+dos.data[i].aid+"' onclick='delUserRess(this)'>删除地址</button></li>";
            $(".gengduodizhi").append(stt);
        }
...
//点击订单管理
function dianjiDingdan() {
    //删除现有右边展示
    $("#xixi").empty();
    //修改右边顶部字段
    $(".tor-span").text("订单管理")

    $.post("/user.do?method=getUserBydingdanAllwu",function (dom) {

        if(dom.code==200){
            //加载订单信息

            for(var i=0;i<dom.data.length;i++){
                var str="\t\t<div>\n" +
                    "<ul>\n" +
                    "<li>\n" +
                    "<span>订单编号\n" +
                    ...
                    "<div>\n" +
                    "<span>消费金额\n" +
                    "<i>"+dom.data[i].gprive+"</i>\n" +
                    "</span>\n" +
                    "</div>\n" +
                    "<div>\n" +
                    "<button sdid='"+dom.data[i].sdid+"' onclick='dingdanxiangqingU(this)'>查看订单</button>\t\n" +
                    "</div>\n" +
                    "</li>\n" +
                    "</ul>\n" +
                    "<p>====</p>\t\t\t\t\t\t\n" +
            ...
            //加载默认无订单信息
            var str="<div>\n" +
                "\t\t\t\t\t\t\t<div class=\"dduser\" style=\"margin: 15em 0em 0em 30em\">\n" +
                "\t\t\t\t\t\t\t\t<h2>暂无订单信息</h2>\n" +
                "\t\t\t\t\t\t\t</div\n" +
                "\t\t\t\t\t\t\t</div>"
            $("#xixi").append(str)
...
//查看订单详情
function dingdanxiangqingU(dos) {

    var sdid=$(dos).attr("sdid")
    ...
    $.post("/user.do?method=getUserByDingdandanyi",{sdid:sdid},function (nus) {
        console.log(nus)
        if(nus.code==200){
            var stt="<div>\n" +
                "\t\t\t\t\t\t\t\t<div>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t<i>"+nus.data[0].uuid+"</i>\n" +
                "\t\t\t\t\t\t\t\t\t</h3>\n" +
                "\t\t\t\t\t\t\t\t<button class=\"fanhui\" onclick='fanhuixs()'>返回</button>\t\n" +
                "\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t<div>\n" +
                "\t\t\t\t\t\t\t\t\t<h3 class=\"biaotou_biao\">\n" +
                "\t\t\t\t\t\t\t\t\t\t<span>收货地</span>\n" +
                "\t\t\t\t\t\t\t\t\t\t<i>|</i>\n" +
                "\t\t\t\t\t\t\t\t\t\t<span>商品数量</span>\n" +
                "\t\t\t\t\t\t\t\t\t\t<i>|</i>\n" +
            ...
            //添加订单详情：
            for(var vs=0;vs<nus.data.length;vs++){

                //拿到订单时间
                var  timdedetail=nus.data[vs].creationtime;//假如是10位毫秒需要乘1000
                ...
                var st="<h5 class=\"goodsput\">\n" +
                    "\t\t\t\t\t\t\t\t\t\t<em>"+nus.data[vs].address+"</em>\n" +
                    "\t\t\t\t\t\t\t\t\t\t<span>"+nus.data[vs].gnum+"</span>\n" +
                    "\t\t\t\t\t\t\t\t\t\t<span>"+nus.data[vs].gprive+"</span>\n" +
                    "\t\t\t\t\t\t\t\t\t\t<span>"+time+"</span>\n" +
                    "\t\t\t\t\t\t\t\t\t</h5>"
                $(".addGo").append(st)
            }
